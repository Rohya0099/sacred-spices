...
-- CreateEnum
CREATE TYPE "GeneratedContentType" AS ENUM ('INSTAGRAM_CAPTION', 'AD_COPY', 'WHATSAPP_MESSAGE', 'FESTIVAL_CAMPAIGN', 'PRODUCT_STORY', 'EMAIL_COPY');
...
CREATE TABLE "Product" (
    ...
    "emotionalStory" TEXT NOT NULL,
    "ingredients" TEXT[],
    "tasteProfile" TEXT[],
    "regionalInspiration" TEXT NOT NULL,
    "cookingRecommendations" TEXT[],
...
CREATE TABLE "Subscription" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Sacred Monthly Box',
